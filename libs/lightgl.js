...
Buffer.prototype = {
  ...
  // ### .delete()
  //
  // Deletes the selected buffer off the GPU.  Should only be used when the data is no
  // longer to be used any longer.  Example usage:
  //
  //     buf.delete();  // remove data from GPU
  //     delete buf;    // delete javascript object instance
  // 
  delete: function() {
